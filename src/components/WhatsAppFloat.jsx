...
export default function WhatsAppFloat() {
  ...
  return (
    ...
    >
      {/* Tooltip */}
      {tooltip && (
        <div className="bg-brand-navy-dark border border-white/10 px-4 py-2 shadow-xl animate-fade-in-up">
          <p className="font-body text-white text-xs whitespace-nowrap">
      ...
      {/* Button */}
      <a
        href="https://wa.me/34613021897?text=Hello,%20I'm%20interested%20in%20used%20heavy%20equipment."
        target="_blank"
